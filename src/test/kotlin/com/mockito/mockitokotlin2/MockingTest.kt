...
import com.mockito.mockitokotlin2.UseConstructor.Companion.parameterless
import com.mockito.mockitokotlin2.UseConstructor.Companion.withArguments
...
class MockingTest : TestBase() {
    ...
    @Test
    fun `Mocking Lambda with useIR true fails`() {
        val function = mock<(Int, Int) -> Int>()

        whenever(function(any(), any())).thenReturn(42)

        val result = function(2, 2)
        assertEquals(42, result)
    }

    @Test
    fun `Mocking functions with useIR true fails`() {
        val function = mock<Function2<Int, Int, Int>>()
